...
if n_extra_channels == 0:
    ...
    train_x_paths, train_y_paths, train_extra_x_paths = make_xy_path_list(train_x_dirs, train_y_dirs, extra_x_paths=train_extra_x_dirs)
    n_train_data = len(train_x_paths)
...
if n_extra_channels == 0:
    ...
    valid_x_paths, valid_y_paths, valid_extra_x_paths = make_xy_path_list(valid_x_dirs, valid_y_dirs, extra_x_paths=valid_extra_x_dirs)
    n_valid_data = len(valid_x_paths)
